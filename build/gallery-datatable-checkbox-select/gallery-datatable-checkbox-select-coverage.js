...
this.addColumn(colSel,0);
            ...
            _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 401);
if (this.get('rendered') === true) {
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 402);
this.syncUI(); // BUGFIX: stlsmiths/yui3-gallery#7: Do not call sync before the table has been rendered.
    ...
    _uiRemoveCheckboxTH: function(){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_uiRemoveCheckboxTH", 413);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 414);
this.removeColumn(this.colSelect);
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 415);
this.syncUI();
    },
    ...
    _uiCheckboxSetEach: function(bool){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_uiCheckboxSetEach", 424);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 425);
var inps = this.get('srcNode').all("."+this.getClassName("data") + " ."+this.getClassName("checkbox","select"));
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 426);
inps.each(function(n){
            _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 6)", 426);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 427);
n.set('checked',bool);
        });
    ...
    _uiAllChecksSet: function(bool){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_uiAllChecksSet", 438);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 439);
var sa = this.get('srcNode').one("."+this.getClassName("checkbox","select","all"));
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 440);
...
//------------   Primary Key functions  --------------
    ...
    _valPrimaryKeys: function(){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_valPrimaryKeys", 462);
...
Y.Array.each(cols,function(c){
            _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 7)", 466);
...
if( c && c.primaryKey && c.primaryKey === true) {
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 468);
var ckey = c.key || c.name || null;
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 469);
if(ckey) {
                    _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 470);
pks.push(ckey);
                }
            }
        });
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 474);
return pks;
    },
    ...
    _setPrimaryKeys: function(pkn){
        ...
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_setPrimaryKeys", 488);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 490);
if (Y.Lang.isArray(pkn))
            {_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 491);
pks = pkn;}
        else {_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 492);
if (Y.Lang.isString(pkn))
            {_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 493);
pks = [ pkn ];}}

        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 495);
return pks;
    },
    ...
    _getRecordforPKvalue: function(pkv){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_getRecordforPKvalue", 508);
...
var recs = this.data.filter(function(r){
            _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 8)", 510);
...
if(Y.Lang.isObject(pkv)) {
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 512);
var flag = true;
...
Y.Object.each(pkv,function(v,k){
                    _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 9)", 513);
...
return true;}
                ...
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 519);
if(r.get(pkeys[0]) === pkv )
                    {_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 520);
return true;}
            }
        });
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 523);
return (recs && recs.length===1)  ? recs[0] : recs;
    ...
    _getPKValues: function(rec){
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_getPKValues", 541);
...
if(!pkeys || !Y.Lang.isArray(pkeys) || !rec) {return false;}
        ...
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 545);
var rtn;
...
rtn = rec.get(pkeys[0]);}
            ...
            _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 549);
rtn = {};
            _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 550);
Y.Array.each(pkeys,function(pk){
                _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 10)", 550);
...
if( pk ) {rtn[pk] = rec.get(pk);}
        ...
        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 554);
return rtn;
    },
    ...
    _indexOfObjMatch: function(arr,key_vals) {
        _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "_indexOfObjMatch", 567);
...
Y.Array.some(arr,function(item,index){
            _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 11)", 570);
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 571);
var bool = true;
...
Y.Object.each(key_vals,function(v,k){
                _yuitest_coverfunc("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", "(anonymous 12)", 572);
...
if(item[k] !== v) {bool = false;}
            ...
            _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 575);
if (bool) {
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 576);
imatch = index;
                _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 577);
return true;
            }
        });

        _yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 581);
return imatch;
    }

});

_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 586);
...
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 658);
Y.DataTable.CheckboxSelect = DtCheckboxSelect;
_yuitest_coverline("build/gallery-datatable-checkbox-select/gallery-datatable-checkbox-select.js", 659);
